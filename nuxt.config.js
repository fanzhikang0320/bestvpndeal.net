...
export default {
  ...
  head: {
    ...
    meta: [
      { charset: 'utf-8' },
      { hid: 'description', name: 'description', content: 'bestvpndeal  helps you find the best VPN provider of 2021. Honest user & experts reviews on VPNs - speed, price, features. ' },
